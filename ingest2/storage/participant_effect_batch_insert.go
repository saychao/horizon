...
func history2ParticipantEffectBatchInsert(repo *pgdb.DB, rows []history2.ParticipantEffect, tableName string, columns []string, converter history2ParticipantEffectConvertToValues) error {
	if len(rows) == 0 {
		return nil
	}
